...
// Тело запроса на получения списка пользователей
...
// Тело ответа на получение списка пользователей
type ListResponse struct {
	...
	// Общее количество пользователей по заданному запросу
...
type ListRequest_Filter struct {
	...
	GroupIdIn []string `protobuf:"bytes,2,rep,name=group_id_in,json=groupIdIn,proto3" json:"group_id_in,omitempty"`
}
...
func (*ListRequest_Filter) Descriptor() ([]byte, []int) {
	return file_api_users_users_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ListRequest_Filter) GetGroupIdIn() []string {
	if x != nil {
		return x.GroupIdIn
	}
	return nil
...
var file_api_users_users_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x22,
	...
	0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x06, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x1a, 0x3d, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x13, 0x0a,
	0x05, 0x69, 0x64, 0x5f, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x69, 0x64,
	0x49, 0x6e, 0x12, 0x1e, 0x0a, 0x0b, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x5f, 0x69,
	0x6e, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64,
	0x49, 0x6e, 0x22, 0x48, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x45, 0x0a, 0x04,
	...
	0x70, 0x49, 0x64, 0x32, 0x3c, 0x0a, 0x05, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x33, 0x0a, 0x04,
	...
	0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x47, 0x72, 0x70, 0x63, 0x41, 0x70, 0x70, 0x2f, 0x75, 0x73,
	0x65, 0x72, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x73, 0x3b, 0x75, 0x73,
...
var file_api_users_users_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_users_users_proto_goTypes = []interface{}{
	(*ListRequest)(nil),        // 0: server.ListRequest
	(*ListResponse)(nil),       // 1: server.ListResponse
	(*User)(nil),               // 2: server.User
	(*ListRequest_Filter)(nil), // 3: server.ListRequest.Filter
}
var file_api_users_users_proto_depIdxs = []int32{
	3, // 0: server.ListRequest.filter:type_name -> server.ListRequest.Filter
	2, // 1: server.ListResponse.items:type_name -> server.User
	0, // 2: server.Users.List:input_type -> server.ListRequest
	1, // 3: server.Users.List:output_type -> server.ListResponse
